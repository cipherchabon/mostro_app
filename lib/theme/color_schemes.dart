...
const lightColorScheme = ColorScheme(
  ...
  primary: Color(0xFF416900),
  onPrimary: Color(0xFFFFFFFF),
  primaryContainer: Color(0xFFB7F568),
  ...
  inversePrimary: Color(0xFF9CD84F),
  shadow: Color(0xFF000000),
  surfaceTint: Color(0xFF416900),
...
const darkColorScheme = ColorScheme(
  ...
  primary: Color(0xFF9CD84F),
  onPrimary: Color(0xFF203700),
  primaryContainer: Color(0xFF304F00),
  onPrimaryContainer: Color(0xFFB7F568),
  ...
  inversePrimary: Color(0xFF416900),
  shadow: Color(0xFF000000),
  surfaceTint: Color(0xFF9CD84F),
