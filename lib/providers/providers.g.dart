...
String _$secureLocalStorageHash() =>
    r'9b1b8336b2718cf3271a7cb7e9fe551d803e23a0';

/// See also [secureLocalStorage].
@ProviderFor(secureLocalStorage)
final secureLocalStorageProvider = Provider<SecureLocalStorage>.internal(
  secureLocalStorage,
...
final authRepositoryProvider = Provider<PinRepository>.internal(
  authRepository,
